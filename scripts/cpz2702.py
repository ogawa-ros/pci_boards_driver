...
class CPZ2702(object):
    ...
    def __init__(self):
        ...
        self.pub = [rospy.Publisher(
                        name = "cpz2702_rsw{0}/di{1}".format(self.rsw_id, ch),
        ...
        self.sub = [rospy.Subscriber(
                        name = "cpz2702_rsw{0}/do{1}".format(self.rsw_id, ch),
                        data_class = std_msgs.msg.Bool,
        ...
        try:
            self.dio = pyinterface.open(2702, self.rsw_id)
        except OSError as e:
